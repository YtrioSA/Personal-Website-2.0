<script>
    ...
    let [like,dislike,id] = [0,0,1];
    export let data;

    onMount(() => {
        like    = data.votes[0].like;
        dislike = data.votes[0].dislike;
    });
...
<iframe title="music" src="/music" width="0" height="0"></iframe>
<div class="flex justify-center items-center h-full w-full">
    <div class="bg-[#0F2B45]/95 border-[3px] rounded-md h-[590px] w-[65%]">
        <div class="gap-4 flex flex-col justify-center items-center mt-[-5%]">
            <div class="avatar">
                <div
                    class="w-48 rounded-full ring ring-[#FFF] ring-offset-base-100 ring-offset-1"
                >
                    <img src="./hacker.webp" alt="" />
                </div>
            </div>
            <div class="flex gap-4 text-[#000]">
                <h1>{like}</h1>
                    <form action="?/like" method="POST">
                        <input type="hidden" name="id"   value="{id}">
                        <input type="hidden" name="like" value="{like}">
                        <button class="border-none bg-transparent" on:click={updateLike} type="submit">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 20 20"><path fill="currentColor" d="M1 8.25a1.25 1.25 0 1 1 2.5 0v7.5a1.25 1.25 0 1 1-2.5 0v-7.5ZM11 3V1.7c0-.268.14-.526.395-.607A2 2 0 0 1 14 3c0 .995-.182 1.948-.514 2.826c-.204.54.166 1.174.744 1.174h2.52c1.243 0 2.261 1.01 2.146 2.247a23.864 23.864 0 0 1-1.341 5.974C17.153 16.323 16.072 17 14.9 17h-3.192a3 3 0 0 1-1.341-.317l-2.734-1.366A3 3 0 0 0 6.292 15H5V8h.963c.685 0 1.258-.483 1.612-1.068a4.011 4.011 0 0 1 2.166-1.73c.432-.143.853-.386 1.011-.814c.16-.432.248-.9.248-1.388Z"/></svg>
                        </button>    
                    </form>
                    <form action="?/dislike" method="POST">
                        <input type="hidden" name="id"      value="{id}">
                        <input type="hidden" name="dislike" value="{dislike}">
                        <button class="border-none bg-transparent" on:click={updateDislike} type="submit">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 20 20"><path fill="currentColor" d="M18.905 12.75a1.25 1.25 0 0 1-2.5 0v-7.5a1.25 1.25 0 1 1 2.5 0v7.5Zm-10 4.25v1.3c0 .268-.14.526-.395.607A2 2 0 0 1 5.905 17c0-.995.182-1.948.514-2.826c.204-.54-.166-1.174-.744-1.174h-2.52c-1.242 0-2.26-1.01-2.146-2.247c.193-2.08.652-4.082 1.341-5.974C2.752 3.678 3.833 3 5.005 3h3.192a3 3 0 0 1 1.342.317l2.733 1.366A3 3 0 0 0 13.613 5h1.292v7h-.963c-.684 0-1.258.482-1.612 1.068a4.012 4.012 0 0 1-2.165 1.73c-.433.143-.854.386-1.012.814c-.16.432-.248.9-.248 1.388Z"/></svg>
                        </button>    
                    </form>
                <h1>{dislike}</h1>
            </div>
            <h1 class="font-semibold text-4xl uppercase text-[#000]">
                ytrio salmito
            </h1>
            <h3 class="gap-2 flex items-center text-2xl text-[#000]">
                Desenvolvedor Web
                <svg
                    alt="Coffe <3"
                    ...
                    ><g
                        ...
                        /><path
                            d="M3 10h14v5a6 6 0 0 1-6 6H9a6 6 0 0 1-6-6v-5z"
                        /><path d="M16.746 16.726a3 3 0 1 0 .252-5.555" /></g
                    >
                    <title>Coffe S2</title>    
                    </svg
                >
                <svg
                    xmlns="http://www.w3.org/2000/svg"
...
<title> Quando eu morrer vocês saberam a onde me encontrar 💙 </title>
</svg>
            </h3>
            ...
            <div class="flex justify-center gap-4 mt-[5px]">
                <a
                    target="_blank"
                    style="color:#000"
                    href="https://discord.com/users/692174529459519608"
                    ><svg class="hover:text-[#FFF]"
                ...
                <a
                    target="_blank"
                    style="color:#000"
                    href="https://www.twitch.tv/cyberneticcipher"
                    ><svg
                        class="hover:text-[#FFF]"
                        xmlns="http://www.w3.org/2FFF/svg"
                        width="64"
                ...
                <a
                    target="_blank"
                    style="color:#000"
                    href="https://telegram.me/ytriosa"
                    ><svg
                        class="hover:text-[#FFF]"
                        xmlns="http://www.w3.org/2FFF/svg"
                        width="64"
                ...
                <a
                    target="_blank"
                    style="color:#000"
                    href="https://www.instagram.com/ytriosalmitogc/"
                    ><svg
                        class="hover:text-[#FFF]"
                        xmlns="http://www.w3.org/2000/svg"
                        width="64"
                ...
                <a
                    target="_blank"
                    style="color:#000"
                    href="https://steamcommunity.com/profiles/76561199159117637/"
                    ><svg
                        class="hover:text-[#FFF]"
                        xmlns="http://www.w3.org/2000/svg"
                        width="64"
